# DESIGN：基于触觉反馈的小提琴人形机器人系统设计（Violin-Playing Humanoid with Tactile Feedback）

> 目标：把“小提琴演奏”当作 **contact-rich 双手协作** 系统工程问题来做。
> 核心打法（来自 `vla-interview-handbook`）：**高层负责意图与协作编排；低层用可解释的触觉/力控闭环（System0/反射层）兜底**。
...
> 参考：`vla-interview-handbook/deployment/perception/tactile_array_algorithms_capacitive_piezoresistive.md`
